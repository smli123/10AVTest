...
import com.sherman.smartlock.dataprovider.SmartPlugActionHelper;
import com.sherman.smartlock.ui.ActionDefine;
...
public class PubFunc {
	...
	public static void addToTable(Context context, ActionDefine action) {
		SmartPlugActionHelper helper = new SmartPlugActionHelper(context);
	...
	public static String getDeviceNameFromModule(String plugType,
		...
		if (plugType.equals(PubDefine.DEVICE_UNKNOWN) == true) {
			...
			return "智能开关";
				...
				&& (deviceType.equals(PubDefine.PRODUCT_SMART_PLUG_AIRCON) == true)) {
			return "智能开关II";
