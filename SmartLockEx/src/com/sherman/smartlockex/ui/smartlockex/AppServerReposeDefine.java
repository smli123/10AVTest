...
import com.sherman.smartlockex.ui.common.CmdDefine;
import com.sherman.smartlockex.ui.common.ServerErrCodeMgr;
...
public class AppServerReposeDefine {
	...
	/**����ID������*/
	public static final int APP_LOCK_ID_NOTEXIST					= 0x10000005;
	/**���������ø������û�*/
	public static final int APP_LOCK_BEEN_ASSIGNED					= 0x10000006;
	/**�û������޴˲���*/
	public static final int APP_USER_NO_PLUG     		            = 0x10000007;
	/**��������Ѿ�����*/
	public static final int APP_LOCK_NAME_EXIST					    = 0x10000008;
	/**���Ӷ�ʱ����ʧ��*/
	public static final int APP_LOCK_ADD_TIMER_FAIL  			    = 0x10000009;
	/**�޸Ķ�ʱ����ʧ��*/
	public static final int APP_LOCK_MOD_TIMER_FAIL					= 0x1000000A;
	/**ɾ��ʱ����ʧ��*/
	public static final int APP_LOCK_DEL_TIMER_FAIL 				= 0x1000000B;
	/**���ʱ�޷���*/
	public static final int APP_LOCK_CMD_TIMEOUT   				    = 0x1000000C;
	/**��������*/
	public static final int APP_LOCK_OFFLINE						= 0x1000000D;
	/**���䲻����*/
	...
	static
	{
		...
		m_App_Server_Response.add(new CmdDefine(ServerErrCodeMgr.ERROR_CODE_MODULE_ID_UNREGISTERED, null, R.string.app_response_lock_not_exist));
		m_App_Server_Response.add(new CmdDefine(ServerErrCodeMgr.ERROR_CODE_MODULE_ID_REGISTERED, null, R.string.app_response_lock_been_assigned));
		m_App_Server_Response.add(new CmdDefine(APP_USER_NO_PLUG, null, R.string.app_response_user_no_plug));
		m_App_Server_Response.add(new CmdDefine(APP_LOCK_NAME_EXIST, null, R.string.app_response_lock_name_exist));
		m_App_Server_Response.add(new CmdDefine(ServerErrCodeMgr.ERROR_CODE_MODULE_NOT_ANSWER, null, R.string.app_response_lock_noresponse));
		m_App_Server_Response.add(new CmdDefine(ServerErrCodeMgr.ERROR_CODE_MODULE_IS_OFFLINE, null, R.string.app_response_lock_offline));
