...
import com.sherman.smartlock.internet.RevCmdFromSocketThread;
import com.sherman.smartlock.internet.UDPClient;
...
public class DetailWindowActivity extends TitledActivity
		implements
			OnClickListener {
		...
		public void onReceive(Context context, Intent intent) {
			...
			if (intent.getAction().equals(PubDefine.PLUG_NOTIFY_ONLINE)) {
				if (true == NotifyProcessor.onlineNotify(
						DetailWindowActivity.this, intent)) {
					updateUI();
				}
			}
		...
		switch (view.getId()) {
			...
			case R.id.titlebar_rightbutton :
				...
				if (btn_TitleRight.getText().equals(
					...
					intent.setClass(DetailWindowActivity.this,
