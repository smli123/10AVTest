...
public class DetailIRSceneActivity extends TitledActivity
		implements
			OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState, R.layout.activity_ir_scene_timer,
				false);
	...
	private void init() {
		...
		sp_temperature
				.setOnItemSelectedListener(new IRSceneTemperatureListener());
	...
	private void refreshUI() {
		...
		int select_no = irTemperaturelist
				.indexOf(String.valueOf(i_temperature));
		if (select_no == -1) {
	...
	class IRSceneTemperatureListener
			implements
	...
	private void showTemperatures() {
		ActionSheetDialog dlg = new ActionSheetDialog(
				DetailIRSceneActivity.this)
				.builder()
				.setTitle(
						DetailIRSceneActivity.this
								.getString(R.string.smartplug_oper_selecttemperature_title))
	...
	private void addIRScene() {
		...
		ir.mPeriod = String.valueOf(i_period_7) + String.valueOf(i_period_1)
				+ String.valueOf(i_period_2) + String.valueOf(i_period_3)
				+ String.valueOf(i_period_4) + String.valueOf(i_period_5)
	...
	private void addSceneServerData(IRSceneDefine ir) {
		...
		sb.append(SmartPlugMessage.CMD_SP_ADDIRSCENE)
	...
	private void deleteSceneServerData(IRSceneDefine ir) {
		...
		StringBuffer sb = new StringBuffer();
		sb.append(SmartPlugMessage.CMD_SP_DELIRSCENE)
				.append(StringUtils.PACKAGE_RET_SPLIT_SYMBOL)
				.append(PubStatus.g_CurUserName)
				.append(StringUtils.PACKAGE_RET_SPLIT_SYMBOL).append(mPlugID)
				.append(StringUtils.PACKAGE_RET_SPLIT_SYMBOL).append(info);
	...
	private void modifySceneServerData(IRSceneDefine ir) {
		...
		StringBuffer sb = new StringBuffer();
		sb.append(SmartPlugMessage.CMD_SP_MODIFYIRSCENE)
				.append(StringUtils.PACKAGE_RET_SPLIT_SYMBOL)
				.append(PubStatus.g_CurUserName)
				.append(StringUtils.PACKAGE_RET_SPLIT_SYMBOL).append(mPlugID)
				.append(StringUtils.PACKAGE_RET_SPLIT_SYMBOL).append(info);
	...
	private void enableSceneServerData(IRSceneDefine ir) {
		...
		StringBuffer sb = new StringBuffer();
		sb.append(SmartPlugMessage.CMD_SP_ENABLEIRSCENE)
				.append(StringUtils.PACKAGE_RET_SPLIT_SYMBOL)
				.append(PubStatus.g_CurUserName)
				.append(StringUtils.PACKAGE_RET_SPLIT_SYMBOL).append(mPlugID)
				.append(StringUtils.PACKAGE_RET_SPLIT_SYMBOL).append(info);
