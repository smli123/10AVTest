...
public class SmartPlugHelper {
	...
	// 获取用户的所有插座，包括模拟PC
	public ArrayList<SmartPlugDefine> getAllSmartPlugEx(String user) {
		ArrayList<SmartPlugDefine> plugs = new ArrayList<SmartPlugDefine>();
		if (null == mContentResolver) {
			return null;
		}
	...
	// 获得所有插座
	public ArrayList<String> getAllSmartPlugPCName(String plugID) {
		ArrayList<SmartPlugDefine> plugs = new ArrayList<SmartPlugDefine>();
		if (null == mContentResolver) {
			return null;
		}
	...
	public String getPlugIDFromMac(String relatedModuleID, String mac) {
		ArrayList<SmartPlugDefine> plugs = new ArrayList<SmartPlugDefine>();
		if (null == mContentResolver) {
			return null;
		}
		...
		for (SmartPlugDefine plug : plugs) {
			if (plug.mMAC.equals(mac) && plug.mPlugId.contains(relatedModuleID)) {
				return plug.mPlugId;
			}
		}
		return null;
